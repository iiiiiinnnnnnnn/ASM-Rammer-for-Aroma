...
#define DEBUG_FUNCTION_LINE_VERBOSE_EX(FMT, ...)                           while (0)

#define DEBUG_FUNCTION_LINE_VERBOSE(FMT, ...)                              while (0)

#define DEBUG_FUNCTION_LINE(FMT, ...)                                      while (0)

#define DEBUG_FUNCTION_LINE_WRITE(FMT, ...)                                while (0)

#define DEBUG_FUNCTION_LINE_ERR(FMT, ...)                                  while (0)
#define DEBUG_FUNCTION_LINE_WARN(FMT, ...)                                 while (0)
#define DEBUG_FUNCTION_LINE_INFO(FMT, ...)                                 while (0)

#define DEBUG_FUNCTION_LINE_ERR_LAMBDA(FILENAME, FUNCTION, LINE, FMT, ...) while (0)
